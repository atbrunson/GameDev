import { Render, Engine, Events, Mouse, MouseConstraint, Composite, Bounds, Vector } from "matter-js";
import { engine, render } from "./main.js";	//imported from main.js
// Create mouse element & mouse constraint to allow mouse controls

// Check document.render for mouse typeof Mouse
// Check docum
...
Events.on(render, 'beforeRender', function () {
	...
	// ZOOM THE VIEWPORT if scale has changed
	...
	// PAN THE VIEWPORT
	// get the mouse position in relation to the viewport
	// we use mouse.absolute rather than mouse.position as the latter is constrained by the bounds
